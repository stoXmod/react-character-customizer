...
import {useCharacterAnimations} from "../contexts/CharacterAnimations.js";
import {useCharacterCustomization} from "../contexts/CharacterCustomizationContext.js";
...
function Woman() {
  ...
  const { nodes, materials, animations } = useGLTF("./models/woman.gltf") as GLTFResult;
